...
export const experience: Role[] = [
  {
    ...
    focus: "Deposit Tech Domain: architecture, regulatory initiatives, migrations, and production engineering for Savings Accounts and Time Deposits on Thought Machine Vault",
    achievements: [
      "Re-architected account migration processing into a distributed batch pipeline with 100 concurrent workers, increasing throughput 6.7× (2.93 → 19.57 accounts/sec) and reducing estimated runtime for 500K-account migrations from ~47 hours to ~7 hours",
  ...
  },
  {
    ...
    focus: "Cross-platform backend engineer supporting three internal platforms: CRM tooling, feature enhancements, and knowledge sharing",
    achievements: [
  ...
  },
  {
    ...
    focus: "AWS infrastructure modernization, blockchain optimization, and asynchronous processing",
    achievements: [
      ...
      "Implemented RabbitMQ-based asynchronous mail processing, reducing queue latency by 60% and enabling 3× higher throughput under peak load",
    ],
  },
  {
    ...
    focus: "API modernization and development pipeline automation for food delivery platform",
    achievements: [
  ...
  },
  {
    ...
    focus: "RESTful API development, quality assurance, and regression prevention",
    achievements: [
